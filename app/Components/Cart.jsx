  ...
  return (
    <>
      ...
      >
        ...
        <span
          className="absolute -top-1 -right-1 flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-[#82b440] rounded-full"
          title={
            cart.length === 0 ? "No cart avaliable" : `you have ${cart.length}`
          }
        >
          {cart.length}
        </span>
